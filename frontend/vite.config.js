...
var BACKEND_TARGET = process.env.VITE_BACKEND_URL || "http://127.0.0.1:8000";
export default defineConfig(function (_a) {
    var mode = _a.mode;
    var rootDir = path.dirname(fileURLToPath(import.meta.url));
    var isProd = mode === "production";
    var isAnalyze = mode === "analyze";
    return {
        plugins: [
            react({
                ...
                output: {
                    manualChunks: function (id) {
                        ...
                        if (normalizedId.includes("/src/features/dashboard/")) {
                            if (normalizedId.includes("/src/features/dashboard/components/Collections") ||
                            ...
                            if (normalizedId.includes("/src/features/dashboard/components/OverviewCards") ||
                        ...
                        if (normalizedId.includes("/src/shared/components/charts/") ||
                    ...
                    assetFileNames: function (_a) {
                        var name = _a.name;
                        if (/\.(png|jpe?g|svg|gif|webp)$/i.test(name !== null && name !== void 0 ? name : "")) {
                            return "assets/images/[name]-[hash][extname]";
                        }
                        if (/\.css$/i.test(name !== null && name !== void 0 ? name : "")) {
